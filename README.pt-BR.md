...
| **Humano no loop**                   | Consulte o [contrato atual de envio de candidaturas](docs/APPLY_AUTOFILL.md). |
...
Não como fluxo em massa ou em segundo plano. O modo interativo `apply` deixa o envio com você; o driver híbrido, executado separadamente, pode enviar uma única candidatura elegível somente depois de passar pelo gate final. Consulte as [regras completas de envio](docs/APPLY_AUTOFILL.md).
