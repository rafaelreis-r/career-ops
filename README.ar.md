...
| **المرشح في قلب القرار (Human-in-the-Loop)** | راجع [عقد إرسال طلبات التوظيف الحالي](docs/APPLY_AUTOFILL.md). |
...
ليس كسير عمل جماعي أو في الخلفية. يترك وضع `apply` التفاعلي الإرسال لك، بينما قد يرسل برنامج التشغيل الهجين المنفصل طلبًا مؤهلاً واحدًا فقط بعد اجتياز بوابة الأمان النهائية. راجع [قواعد الإرسال الكاملة](docs/APPLY_AUTOFILL.md).
