...
| **Human-in-the-Loop**         | См. [актуальные правила отправки заявок](docs/APPLY_AUTOFILL.md). |
...
Не как массовый или фоновый процесс. Интерактивный режим `apply` оставляет отправку вам; отдельно запускаемый гибридный драйвер может отправить одну допустимую заявку только после прохождения финальной проверки. См. [полные правила отправки](docs/APPLY_AUTOFILL.md).
